 ...
 */
const LauncherRocketBarrelDefinition: BarrelDefinition = {
    angle: Math.PI,
    offset: 0,
    size: 70,
    width: 72,
 ...
 */
export default class LauncherRocket extends Bullet implements BarrelBase {
    /** The rocket's barrel */
    ...
    public constructor(barrel: Barrel, tank: BarrelBase, tankDefinition: TankDefinition | null, shootAngle: number) {
        ...
        const rocketBarrel = this.rocketBarrel = new Barrel(this, {...LauncherRocketBarrelDefinition});
    ...
    public tick(tick: number) {
        ...
        if (!this.deletionAnimation && this.rocketBarrel) this.rocketBarrel.definition.width = ((this.barrelEntity.definition.width / 2) * LauncherRocketBarrelDefinition.width) / this.physicsData.values.size;
