...
const BirthdayGuardianSpawnerDefinition: BarrelDefinition = {
    angle: Math.PI,
    offset: 0,
    size: 130,
    width: 71.4,
...
const BirthdayGuardianSpawnerDefinition2: BarrelDefinition = {
    angle: Math.PI,
    offset: 0,
    size: 100,
    width: 109.2,
...
export default class Guardian extends AbstractBoss {
    public constructor(game: GameServer) {
        ...
        this.nameData.values.name = 'Birthday Guardian';
        ...
        this.barrels.push(new Barrel(this, BirthdayGuardianSpawnerDefinition));
        this.barrels.push(new Barrel(this, BirthdayGuardianSpawnerDefinition2));
    }
